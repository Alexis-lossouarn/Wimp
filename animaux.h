...
class Animaux : public QObject
{
    ...
    Q_PROPERTY(QString nom_animal READ getNom_animal NOTIFY animaux)
    ...
    Q_PROPERTY(double distance READ getDistance_animal NOTIFY animaux)
...
public:
    ...
    double getDistance_animal() const;
